...
public class Denuncias5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_denuncias5);
        ...
        Button siguiente = (Button)findViewById(R.id.siguiente5);
        siguiente.setOnClickListener(new View.OnClickListener() {


            @Override
            public void onClick(View v) {
                Intent intentA = new Intent(v.getContext(), Denuncias6.class);
